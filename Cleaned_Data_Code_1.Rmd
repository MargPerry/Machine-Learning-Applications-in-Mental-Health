...
dat.30 <- newdata[, -which(colMeans(is.na(newdata)) > 0.30)]
```

```{r}
dat.30[ dat.30 == "1" ] <- 1
dat.30[ dat.30 == "5" ] <- 0
dat.30[is.na(dat.30)] <- 0
dat.30$V07657 = as.factor(dat.30$V07657)
dat.30$V07655 = as.factor(dat.30$V07655)
dat.30$V07876 = as.factor(dat.30$V07876)
...
```{r}
dat.30[is.na(dat.30)] <- 5
dat.30$V07657 = as.factor(dat.30$V07657)
dat.30$V08311 = as.factor(dat.30$V08311)
dat.30$V08312 = as.factor(dat.30$V08312)
dat.30$V07655 = as.factor(dat.30$V07655)
dat.30$V05700 = as.factor(dat.30$V05700)
dat.30$V07876 = as.factor(dat.30$V07876)
dat.30$V03221 = as.factor(dat.30$V03221)
dat.30$V03223 = as.factor(dat.30$V03223)
dat.30$V03224 = as.factor(dat.30$V03224)
dat.30$V03225 = as.factor(dat.30$V03225)
dat.30$V03226 = as.factor(dat.30$V03226)
dat.30$V03227 = as.factor(dat.30$V03227)
dat.30$V03228 = as.factor(dat.30$V03228)
dat.30$V03229 = as.factor(dat.30$V03229)
dat.30$V03230 = as.factor(dat.30$V03230)
dat.30$V03231 = as.factor(dat.30$V03231)
dat.30$V03330 = as.factor(dat.30$V03330)
dat.30$V03331 = as.factor(dat.30$V03331)
dat.30$V03332 = as.factor(dat.30$V03332)
dat.30$V03333 = as.factor(dat.30$V03333)
dat.30$V01993 = as.factor(dat.30$V01993)
